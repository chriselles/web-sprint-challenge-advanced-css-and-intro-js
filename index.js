...
//Removed parentheses from artists id, name, years, genre, nationality, bio, wikipedia, paintings //
//Added commas to end of paintings # //
// Done 
const artists = [
  {
    id: 0,
...
function removeArtist(data, index) {
  data.splice(index, 1);  
  console.log("The new array length is:  " + data.length); 
}
...
addArtist(artists, {
  ...
  name: "Chris Elles",
  years: "1969-2020",
  genre: "Problem Solver",
  nationality: "USA/NZ",
  bio: "Trying the make the world a better place.",
}); 
...
/* STRETCH 1: Programatically console.log HTML element structure.
...
console.log("List of artists with HTML structure: " + getHTML(artists));
